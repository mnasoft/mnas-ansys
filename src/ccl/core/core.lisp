...
(defclass <reference-pressure> (<obj>)
  ((reference-pressure
...
(defclass <heat-transfer-model> (<obj>)
  ((Option
...
(defclass <thermal-radiation-model> (<obj>)
  ((Option
...
(defclass <turbulent-wall-functions> (<obj>)
  ((high-speed-model
...
(defclass <INTERPOLATION-DATA> (<obj>)
  ((Data-Pairs
