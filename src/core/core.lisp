...
(defpackage #:mnas-icem
  (:use #:cl #:mnas-icem/read)
...
(defmethod print-object ((tin <tin>) s)
  ...
  (format s "// Tetin file generated by ~A version ~A~%" "mnas-icem" (mpkg/sys:version "mnas-icem"))
...
(defmethod init-curves ((tin <tin>))
  ...
  (map nil #'(lambda (surf)
               (map nil #'(lambda (curv)
                            (push surf (mnas-icem::<curve>-surfaces curv)))
                    (mnas-icem:coedged surf tin)))
