...
(defun dxf-ddn (infile file &optional (dxf_list "")(directive_file ""))
...
(defun idi-tetin (prt &optional (tetin "") (tol 0.0001) (isRel 1) (idi_options ""))
  "
...
(defun proe-tetin-protcl (prt &optional (tetin ""))
  "
...
(defun step-tetin (infile outfile &optional (facet 0) (tolarg "") (stepver 0) (args ""))
  "
