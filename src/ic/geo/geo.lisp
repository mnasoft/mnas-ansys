...
(defun ic-import-mesh (&optional  (domains "") (do_seg 1) (no_orfn 1) (do_merge 1))
 "
...
(defun ic-update-surface-display (obj)
...
(defun ic-geo-export-to-mesh (merge &optional (fams "") (quiet 0))
 "
...
(defun ic-coords-dir-into-global (pt
                                  &optional
                                    (system ""))
"
