...
(defun import-mesh (&optional  (domains "") (do_seg 1) (no_orfn 1) (do_merge 1))
 "
...
(defun get-unused-part (prefix &optional (no_first_num 0))
"
...
(defun create-surface-curtain (crvs surfs name fam
                                      &optional
                                        (bld_topo 0)
                                        (quiet 0))
"
