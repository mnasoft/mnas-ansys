...
if { [string compare [info hostname] N142013] == 0 } then {
    set mnas_ansys_tcl_dir "d:/home/_namatv/PRG/msys64/home/namatv/quicklisp/local-projects/ANSYS/mnas-ansys/tcl/ic" }
if {[string compare [info hostname] uakazi-note] == 0 } then {
    set mnas_ansys_tcl_dir "d:/PRG/msys64/home/mnaso/quicklisp/local-projects/ANSYS/mnas-ansys/tcl/ic" }

if { [lsearch $auto_path $mnas_ansys_tcl_dir] == -1 } {
    lappend auto_path $mnas_ansys_tcl_dir}

foreach path $auto_path {
    puts $path}

pkg_mkIndex $mnas_ansys_tcl_dir *.tcl
