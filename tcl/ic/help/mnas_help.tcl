...
proc mnas_help {} {
    ...
    mess "ch_all  - Перемещает точки и кривые сопряженные со всеми поверхностями, \n"
    mess "          в соответствующие им семейства. \n"
    mess "ch_vis  - Перемещает точки и кривые сопряженные с видимыми поверхностями,\n"
    mess "          в соответствующие им семейства. \n"
}
